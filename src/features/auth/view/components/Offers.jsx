...
const productos = [
  ...
  { id: 3, nombre: "Bizcocho", descripcion: "Suave y esponjoso, perfecto con café.", precio: "$2.800", tag: "Estandar", imagen: "/RecursosVisuales/PanGurmet.jpg" },
  { id: 4, nombre: "Baguette", descripcion: "Crujiente por fuera, suave por dentro.", precio: "$5.000", tag: "Estandar", imagen: "/RecursosVisuales/bagget.jpg" },
  ...
  { id: 6, nombre: "Waffles", descripcion: "Perfectas para el desayuno.", precio: "$2.200", tag: "Estandar", imagen: "/RecursosVisuales/waffles.jpg" },
];
...
const Offers = () => {
  ...
  const handleCarrito = (producto) => {
    ...
    setSnackbar({
      open: true,
      msg: estaEnCarrito ? `"${producto.nombre}" quitado del carrito` : `"${producto.nombre}" agregado al carrito`,
  ...
  const handleFavorito = (producto) => {
    ...
    setSnackbar({
      open: true,
      msg: esFavorito ? `"${producto.nombre}" quitado de favoritos` : `"${producto.nombre}" añadido a favoritos`,
